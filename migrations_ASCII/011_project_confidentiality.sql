...
INSERT INTO projects (name, created_by, lead_id, status, confidentiality_level, department_id) VALUES
  ('Katodnye materialy novogo pokoleniya', 1, 1, 'active', 'department', 1),
  ('Issledovanie elektrolitov', 21, 21, 'active', 'department', 2),
  ('Prototip tverdotelnogo LIA', 20, 20, 'active', 'confidential', NULL),
  ('Testirovanie tsiklirovaniya', 29, 29, 'active', 'public', 3),
  ('Importozameschenie separatorov', 32, 32, 'active', 'department', 4);
