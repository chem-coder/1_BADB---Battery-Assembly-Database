...
\restrict LaBfuYAczY6EliaYGenRoj8kSYBDoiwc7J4nHEMkTAYEfHffQvQY2fNnk7mDmrO
...
--
-- Name: tape_availability_status; Type: TYPE; Schema: public; Owner: Dalia
--

CREATE TYPE public.tape_availability_status AS ENUM (
    'in_dry_box',
    'out_of_dry_box',
    'depleted'
);
...
ALTER TYPE public.tape_availability_status OWNER TO "Dalia";
...
CREATE TABLE public.auth_log (
    ...
    details jsonb,
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT auth_log_event_check CHECK (((event)::text = ANY (ARRAY[('login_success'::character varying)::text, ('login_failed'::character varying)::text, ('token_refresh'::character varying)::text, ('logout'::character varying)::text, ('register'::character varying)::text, ('password_changed'::character varying)::text])))
);
...
--
-- Name: cycling_cycle_summary; Type: TABLE; Schema: public; Owner: Dalia
--

CREATE TABLE public.cycling_cycle_summary (
...
ALTER TABLE public.cycling_cycle_summary OWNER TO "Dalia";

--
-- Name: cycling_cycle_summary_summary_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--

CREATE SEQUENCE public.cycling_cycle_summary_summary_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.cycling_cycle_summary_summary_id_seq OWNER TO "Dalia";

--
-- Name: cycling_cycle_summary_summary_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Dalia
--

ALTER SEQUENCE public.cycling_cycle_summary_summary_id_seq OWNED BY public.cycling_cycle_summary.summary_id;


--
-- Name: cycling_datapoints; Type: TABLE; Schema: public; Owner: Dalia
--

CREATE TABLE public.cycling_datapoints (
...
ALTER TABLE public.cycling_datapoints OWNER TO "Dalia";

--
-- Name: cycling_datapoints_datapoint_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--

CREATE SEQUENCE public.cycling_datapoints_datapoint_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.cycling_datapoints_datapoint_id_seq OWNER TO "Dalia";

--
-- Name: cycling_datapoints_datapoint_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Dalia
--

ALTER SEQUENCE public.cycling_datapoints_datapoint_id_seq OWNED BY public.cycling_datapoints.datapoint_id;


--
-- Name: cycling_sessions; Type: TABLE; Schema: public; Owner: Dalia
--

CREATE TABLE public.cycling_sessions (
    session_id integer NOT NULL,
    battery_id integer NOT NULL,
    equipment_type text DEFAULT 'generic'::text NOT NULL,
    file_name text,
    file_path text,
    file_hash text,
    channel integer,
...
ALTER TABLE public.cycling_sessions OWNER TO "Dalia";

--
-- Name: cycling_sessions_session_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--

CREATE SEQUENCE public.cycling_sessions_session_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.cycling_sessions_session_id_seq OWNER TO "Dalia";

--
-- Name: cycling_sessions_session_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Dalia
--

ALTER SEQUENCE public.cycling_sessions_session_id_seq OWNED BY public.cycling_sessions.session_id;
...
--
-- Name: feedback; Type: TABLE; Schema: public; Owner: Dalia
--
...
CREATE TABLE public.feedback (
    ...
    resolved_by integer,
    CONSTRAINT feedback_category_check CHECK ((category = ANY (ARRAY['bug'::text, 'feature'::text, 'improvement'::text, 'question'::text, 'other'::text]))),
    CONSTRAINT feedback_status_check CHECK ((status = ANY (ARRAY['open'::text, 'in_progress'::text, 'resolved'::text, 'closed'::text])))
);


ALTER TABLE public.feedback OWNER TO "Dalia";

--
-- Name: feedback_attachments; Type: TABLE; Schema: public; Owner: Dalia
--
...
ALTER TABLE public.feedback_attachments OWNER TO "Dalia";

--
-- Name: feedback_attachments_attachment_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--

CREATE SEQUENCE public.feedback_attachments_attachment_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.feedback_attachments_attachment_id_seq OWNER TO "Dalia";

--
-- Name: feedback_attachments_attachment_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Dalia
--

ALTER SEQUENCE public.feedback_attachments_attachment_id_seq OWNED BY public.feedback_attachments.attachment_id;


--
-- Name: feedback_feedback_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--
...
ALTER SEQUENCE public.feedback_feedback_id_seq OWNER TO "Dalia";

--
-- Name: feedback_feedback_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Dalia
--
...
--
-- Name: field_changelog; Type: TABLE; Schema: public; Owner: Dalia
--

CREATE TABLE public.field_changelog (
    id integer NOT NULL,
...
ALTER TABLE public.field_changelog OWNER TO "Dalia";

--
-- Name: field_changelog_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--

CREATE SEQUENCE public.field_changelog_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.field_changelog_id_seq OWNER TO "Dalia";

--
-- Name: field_changelog_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Dalia
--

ALTER SEQUENCE public.field_changelog_id_seq OWNED BY public.field_changelog.id;
...
--
-- Name: material_properties; Type: TABLE; Schema: public; Owner: Dalia
--
...
CREATE TABLE public.material_properties (
    ...
    updated_at timestamp with time zone,
    updated_by integer,
    CONSTRAINT material_properties_density_chk CHECK (((density_g_ml IS NULL) OR (density_g_ml >= (0)::numeric))),
    CONSTRAINT material_properties_specific_capacity_chk CHECK (((specific_capacity_mah_g IS NULL) OR (specific_capacity_mah_g >= (0)::numeric)))
);


ALTER TABLE public.material_properties OWNER TO "Dalia";

--
-- Name: material_properties_material_property_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--

ALTER TABLE public.material_properties ALTER COLUMN material_property_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.material_properties_material_property_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: material_property_files; Type: TABLE; Schema: public; Owner: Dalia
--

CREATE TABLE public.material_property_files (
    material_property_file_id integer NOT NULL,
    material_property_id integer NOT NULL,
    file_name text NOT NULL,
    mime_type text,
    file_data bytea NOT NULL,
...
ALTER TABLE public.material_property_files OWNER TO "Dalia";

--
-- Name: material_property_files_material_property_file_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--

ALTER TABLE public.material_property_files ALTER COLUMN material_property_file_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.material_property_files_material_property_file_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: material_source_files; Type: TABLE; Schema: public; Owner: Dalia
--

CREATE TABLE public.material_source_files (
    material_source_file_id integer NOT NULL,
...
ALTER TABLE public.material_source_files OWNER TO "Dalia";

--
-- Name: material_source_files_material_source_file_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--

ALTER TABLE public.material_source_files ALTER COLUMN material_source_file_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.material_source_files_material_source_file_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: material_sources; Type: TABLE; Schema: public; Owner: Dalia
--
...
CREATE TABLE public.material_sources (
    ...
    updated_at timestamp with time zone,
    updated_by integer,
    CONSTRAINT material_sources_quality_rating_label_chk CHECK (((quality_rating_label IS NULL) OR (quality_rating_label = ANY (ARRAY['good'::text, 'ok'::text, 'bad'::text, 'tbd'::text])))),
    CONSTRAINT material_sources_quality_rating_score_chk CHECK (((quality_rating_score IS NULL) OR ((quality_rating_score >= 1) AND (quality_rating_score <= 5))))
);


ALTER TABLE public.material_sources OWNER TO "Dalia";

--
-- Name: material_sources_source_id_seq; Type: SEQUENCE; Schema: public; Owner: Dalia
--

ALTER TABLE public.material_sources ALTER COLUMN source_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.material_sources_source_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: project_department_access; Type: TABLE; Schema: public; Owner: Dalia
--

CREATE TABLE public.project_department_access (
    project_id integer NOT NULL,
    department_id integer NOT NULL,
    access_level character varying(20) DEFAULT 'view'::character varying NOT NULL,
    granted_by integer,
    granted_at timestamp with time zone DEFAULT now() NOT NULL,
    expires_at timestamp with time zone,
    CONSTRAINT project_department_access_access_level_check CHECK (((access_level)::text = ANY ((ARRAY['view'::character varying, 'edit'::character varying, 'admin'::character varying])::text[])))
);


ALTER TABLE public.project_department_access OWNER TO "Dalia";
...
--
-- Name: tape_dry_box_state; Type: TABLE; Schema: public; Owner: Dalia
--

CREATE TABLE public.tape_dry_box_state (
    tape_id integer NOT NULL,
    ...
    updated_by integer,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT tape_dry_box_state_removed_after_started_chk CHECK (((removed_at IS NULL) OR (started_at IS NULL) OR (removed_at >= started_at)))
);


ALTER TABLE public.tape_dry_box_state OWNER TO "Dalia";
...
CREATE TABLE public.tape_step_coating (
    ...
    coating_sidedness text,
    CONSTRAINT tape_step_coating_coating_sidedness_chk CHECK (((coating_sidedness IS NULL) OR (coating_sidedness = ANY (ARRAY['one_sided'::text, 'two_sided'::text]))))
);
...
CREATE TABLE public.tapes (
    ...
    updated_by integer,
    updated_at timestamp with time zone NOT NULL,
    availability_status public.tape_availability_status DEFAULT 'out_of_dry_box'::public.tape_availability_status NOT NULL
);
...
CREATE TABLE public.users (
    ...
    department_id integer,
    CONSTRAINT users_role_check CHECK (((role)::text = ANY (ARRAY[('employee'::character varying)::text, ('lead'::character varying)::text, ('admin'::character varying)::text])))
);
...
--
-- Name: cycling_cycle_summary summary_id; Type: DEFAULT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_cycle_summary ALTER COLUMN summary_id SET DEFAULT nextval('public.cycling_cycle_summary_summary_id_seq'::regclass);


--
-- Name: cycling_datapoints datapoint_id; Type: DEFAULT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_datapoints ALTER COLUMN datapoint_id SET DEFAULT nextval('public.cycling_datapoints_datapoint_id_seq'::regclass);


--
-- Name: cycling_sessions session_id; Type: DEFAULT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_sessions ALTER COLUMN session_id SET DEFAULT nextval('public.cycling_sessions_session_id_seq'::regclass);
...
--
-- Name: feedback feedback_id; Type: DEFAULT; Schema: public; Owner: Dalia
--
...
--
-- Name: feedback_attachments attachment_id; Type: DEFAULT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.feedback_attachments ALTER COLUMN attachment_id SET DEFAULT nextval('public.feedback_attachments_attachment_id_seq'::regclass);


--
-- Name: field_changelog id; Type: DEFAULT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.field_changelog ALTER COLUMN id SET DEFAULT nextval('public.field_changelog_id_seq'::regclass);
...
--
-- Name: cycling_cycle_summary cycling_cycle_summary_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_cycle_summary
    ADD CONSTRAINT cycling_cycle_summary_pkey PRIMARY KEY (summary_id);


--
-- Name: cycling_cycle_summary cycling_cycle_summary_session_id_cycle_number_key; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_cycle_summary
    ADD CONSTRAINT cycling_cycle_summary_session_id_cycle_number_key UNIQUE (session_id, cycle_number);


--
-- Name: cycling_datapoints cycling_datapoints_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_datapoints
    ADD CONSTRAINT cycling_datapoints_pkey PRIMARY KEY (datapoint_id);


--
-- Name: cycling_sessions cycling_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_sessions
    ADD CONSTRAINT cycling_sessions_pkey PRIMARY KEY (session_id);
...
--
-- Name: feedback_attachments feedback_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--
...
--
-- Name: feedback feedback_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--
...
--
-- Name: field_changelog field_changelog_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.field_changelog
    ADD CONSTRAINT field_changelog_pkey PRIMARY KEY (id);
...
--
-- Name: material_properties material_properties_instance_unique; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_properties
    ADD CONSTRAINT material_properties_instance_unique UNIQUE (material_instance_id);


--
-- Name: material_properties material_properties_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_properties
    ADD CONSTRAINT material_properties_pkey PRIMARY KEY (material_property_id);


--
-- Name: material_property_files material_property_files_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_property_files
    ADD CONSTRAINT material_property_files_pkey PRIMARY KEY (material_property_file_id);


--
-- Name: material_source_files material_source_files_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_source_files
    ADD CONSTRAINT material_source_files_pkey PRIMARY KEY (material_source_file_id);


--
-- Name: material_sources material_sources_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_sources
    ADD CONSTRAINT material_sources_pkey PRIMARY KEY (source_id);
...
--
-- Name: project_department_access project_department_access_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.project_department_access
    ADD CONSTRAINT project_department_access_pkey PRIMARY KEY (project_id, department_id);
...
--
-- Name: tape_dry_box_state tape_dry_box_state_pkey; Type: CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.tape_dry_box_state
    ADD CONSTRAINT tape_dry_box_state_pkey PRIMARY KEY (tape_id);
...
--
-- Name: idx_changelog_date; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_changelog_date ON public.field_changelog USING btree (changed_at);


--
-- Name: idx_changelog_entity; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_changelog_entity ON public.field_changelog USING btree (entity_type, entity_id);


--
-- Name: idx_changelog_user; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_changelog_user ON public.field_changelog USING btree (changed_by);


--
-- Name: idx_cycling_dp_session_cycle; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_cycling_dp_session_cycle ON public.cycling_datapoints USING btree (session_id, cycle_number);


--
-- Name: idx_cycling_sessions_battery; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_cycling_sessions_battery ON public.cycling_sessions USING btree (battery_id);


--
-- Name: idx_cycling_sessions_status; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_cycling_sessions_status ON public.cycling_sessions USING btree (status);


--
-- Name: idx_cycling_summary_session; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_cycling_summary_session ON public.cycling_cycle_summary USING btree (session_id);
...
--
-- Name: idx_feedback_created; Type: INDEX; Schema: public; Owner: Dalia
--
...
--
-- Name: idx_feedback_status; Type: INDEX; Schema: public; Owner: Dalia
--
...
--
-- Name: idx_feedback_user; Type: INDEX; Schema: public; Owner: Dalia
--
...
--
-- Name: idx_material_instances_source_id; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_material_instances_source_id ON public.material_instances USING btree (source_id);


--
-- Name: idx_material_properties_instance_id; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_material_properties_instance_id ON public.material_properties USING btree (material_instance_id);


--
-- Name: idx_material_property_files_property_id; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_material_property_files_property_id ON public.material_property_files USING btree (material_property_id);


--
-- Name: idx_material_source_files_source_id; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_material_source_files_source_id ON public.material_source_files USING btree (source_id);


--
-- Name: idx_material_sources_lot_number; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_material_sources_lot_number ON public.material_sources USING btree (lot_number);


--
-- Name: idx_material_sources_material_id; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_material_sources_material_id ON public.material_sources USING btree (material_id);
...
--
-- Name: idx_pda_department; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_pda_department ON public.project_department_access USING btree (department_id);


--
-- Name: idx_pda_expires; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_pda_expires ON public.project_department_access USING btree (expires_at) WHERE (expires_at IS NOT NULL);
...
--
-- Name: idx_upa_expires; Type: INDEX; Schema: public; Owner: Dalia
--

CREATE INDEX idx_upa_expires ON public.user_project_access USING btree (expires_at) WHERE (expires_at IS NOT NULL);
...
--
-- Name: batteries batteries_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.batteries
    ADD CONSTRAINT batteries_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);
...
--
-- Name: cycling_cycle_summary cycling_cycle_summary_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_cycle_summary
    ADD CONSTRAINT cycling_cycle_summary_session_id_fkey FOREIGN KEY (session_id) REFERENCES public.cycling_sessions(session_id) ON DELETE CASCADE;


--
-- Name: cycling_datapoints cycling_datapoints_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_datapoints
    ADD CONSTRAINT cycling_datapoints_session_id_fkey FOREIGN KEY (session_id) REFERENCES public.cycling_sessions(session_id) ON DELETE CASCADE;


--
-- Name: cycling_sessions cycling_sessions_battery_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_sessions
    ADD CONSTRAINT cycling_sessions_battery_id_fkey FOREIGN KEY (battery_id) REFERENCES public.batteries(battery_id) ON DELETE CASCADE;


--
-- Name: cycling_sessions cycling_sessions_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.cycling_sessions
    ADD CONSTRAINT cycling_sessions_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.users(user_id);
...
--
-- Name: electrode_cut_batches electrode_cut_batches_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.electrode_cut_batches
    ADD CONSTRAINT electrode_cut_batches_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);
...
--
-- Name: electrolytes electrolytes_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.electrolytes
    ADD CONSTRAINT electrolytes_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);


--
-- Name: feedback_attachments feedback_attachments_feedback_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.feedback_attachments
    ADD CONSTRAINT feedback_attachments_feedback_id_fkey FOREIGN KEY (feedback_id) REFERENCES public.feedback(feedback_id) ON DELETE CASCADE;


--
-- Name: feedback feedback_resolved_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.feedback
    ADD CONSTRAINT feedback_resolved_by_fkey FOREIGN KEY (resolved_by) REFERENCES public.users(user_id);


--
-- Name: feedback feedback_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--
...
--
-- Name: field_changelog field_changelog_changed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.field_changelog
    ADD CONSTRAINT field_changelog_changed_by_fkey FOREIGN KEY (changed_by) REFERENCES public.users(user_id);
...
--
-- Name: material_instances material_instances_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_instances
    ADD CONSTRAINT material_instances_source_id_fkey FOREIGN KEY (source_id) REFERENCES public.material_sources(source_id) ON DELETE SET NULL;


--
-- Name: material_properties material_properties_material_instance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_properties
    ADD CONSTRAINT material_properties_material_instance_id_fkey FOREIGN KEY (material_instance_id) REFERENCES public.material_instances(material_instance_id) ON DELETE CASCADE;


--
-- Name: material_properties material_properties_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_properties
    ADD CONSTRAINT material_properties_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);


--
-- Name: material_property_files material_property_files_material_property_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_property_files
    ADD CONSTRAINT material_property_files_material_property_id_fkey FOREIGN KEY (material_property_id) REFERENCES public.material_properties(material_property_id) ON DELETE CASCADE;


--
-- Name: material_source_files material_source_files_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_source_files
    ADD CONSTRAINT material_source_files_source_id_fkey FOREIGN KEY (source_id) REFERENCES public.material_sources(source_id) ON DELETE CASCADE;


--
-- Name: material_sources material_sources_material_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_sources
    ADD CONSTRAINT material_sources_material_id_fkey FOREIGN KEY (material_id) REFERENCES public.materials(material_id) ON DELETE RESTRICT;


--
-- Name: material_sources material_sources_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.material_sources
    ADD CONSTRAINT material_sources_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);


--
-- Name: materials materials_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.materials
    ADD CONSTRAINT materials_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);
...
--
-- Name: project_department_access project_department_access_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.project_department_access
    ADD CONSTRAINT project_department_access_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.departments(department_id) ON DELETE CASCADE;


--
-- Name: project_department_access project_department_access_granted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.project_department_access
    ADD CONSTRAINT project_department_access_granted_by_fkey FOREIGN KEY (granted_by) REFERENCES public.users(user_id);


--
-- Name: project_department_access project_department_access_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.project_department_access
    ADD CONSTRAINT project_department_access_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(project_id) ON DELETE CASCADE;
...
--
-- Name: projects projects_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--
...
--
-- Name: separators separators_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.separators
    ADD CONSTRAINT separators_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);


--
-- Name: tape_dry_box_state tape_dry_box_state_tape_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.tape_dry_box_state
    ADD CONSTRAINT tape_dry_box_state_tape_id_fkey FOREIGN KEY (tape_id) REFERENCES public.tapes(tape_id) ON DELETE CASCADE;


--
-- Name: tape_dry_box_state tape_dry_box_state_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.tape_dry_box_state
    ADD CONSTRAINT tape_dry_box_state_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);
...
--
-- Name: tape_process_steps tape_process_steps_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.tape_process_steps
    ADD CONSTRAINT tape_process_steps_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);
...
--
-- Name: tape_recipes tape_recipes_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.tape_recipes
    ADD CONSTRAINT tape_recipes_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);
...
--
-- Name: tapes tapes_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Dalia
--

ALTER TABLE ONLY public.tapes
    ADD CONSTRAINT tapes_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id);
...
\unrestrict LaBfuYAczY6EliaYGenRoj8kSYBDoiwc7J4nHEMkTAYEfHffQvQY2fNnk7mDmrO
