...
COPY public.electrode_cut_batches (cut_batch_id, tape_id, created_by, created_at, comments) FROM stdin;
\.
...
COPY public.tape_step_mixing (step_id, slurry_volume_ml, dry_mixing_id, dry_start_time, dry_duration_min, dry_rpm, wet_mixing_id, wet_start_time, wet_duration_min, wet_rpm) FROM stdin;
\.
