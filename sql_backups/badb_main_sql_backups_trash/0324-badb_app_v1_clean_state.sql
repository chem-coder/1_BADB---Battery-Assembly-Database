...
\restrict gCBAPO2MrgRwg22CuXl2QdWgBROvl2nCmWPufRFKieH0bLpXHh4sCOir9cOnXJ8
...
1	Шаповалов Виктор Васильевич	t
2	Кузнецов Анатолий Викторович	t
3	Абрамова Екатерина Александровна	t
4	Мараулайте Даля Казевна	t
5	Худышкина Анна Денисовна	t
6	Пушкина Ангелина Романовна	t
7	Губкин Александр Владимирович	t
8	Базилевич Юрий Васильевич	t
9	Бахонин Алексей Васильевич	t
10	Шмелев Иван Геннадьевич	t
11	Баталов Роман Сергеевич	t
12	Афанасьева Алина Алексеевна	t
13	Воропаева Дарья Юрьевна	t
14	Щербакова Алена Викторовна	t
15	Зиновьев Тимофей Викторович	t
16	Пасечная Вера Андреевна	t
17	Семерухин Дмитрий Юрьевич	t
18	Черных Маргарита Николаевна	t
19	Пивовар Андрей Сергеевич	t
20	Чудинов Евгений Алексеевич	t
21	Красеньков Сергей Владимирович	t
22	Никифоров Дмитрий Игоревич	t
23	Кочура Константин Дмитриевич	t
24	Санников Илья Константинович	t
25	Мишин Геннадий Александрович	t
26	Демба Елизавета Станиславовна	t
27	Чермашенцев Григорий Романович	t
28	Заплавин Антон Павлович	t
29	Иванищев Александр Викторович	t
30	Алешин Сергей Александрович	t
31	Резвов Сергей Анатольевич	t
32	Иванищева Ирина Анатольевна	t
33	Кириллова Валерия Арамовна	t
34	Меняйлов Дмитрий Сергеевич	t
35	Матвеева Софья Геннадьевна	t
\.
...
SELECT pg_catalog.setval('public.battery_electrochem_battery_electrochem_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.electrolytes_electrolyte_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.material_instance_components_material_instance_component_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.material_instances_material_instance_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.separator_structure_sep_str_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.separators_sep_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.tape_recipe_lines_recipe_line_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.tape_recipes_tape_recipe_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.tapes_tape_id_seq', 1, false);
...
\unrestrict gCBAPO2MrgRwg22CuXl2QdWgBROvl2nCmWPufRFKieH0bLpXHh4sCOir9cOnXJ8
